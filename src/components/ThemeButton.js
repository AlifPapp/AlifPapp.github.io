...
const ThemeToggleButton = () => {
    ...
    return (
        <button onClick={() => setTheme(!enabledTheme)}
            className="absolute w-16 h-16 bottom-2 right-2 sm:bottom-10 sm:right-10 inline-flex items-center justify-center p-2 text-white rounded-full shadow-2xl border-2 border-white z-50">
            {enabledTheme ? (
